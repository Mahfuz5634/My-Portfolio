          ...
          <div className="rounded-3xl border border-emerald-500/40 bg-gradient-to-br from-emerald-500/15 via-slate-900/70 to-slate-950/90 p-6 flex flex-col justify-between backdrop-blur-xl">
            <div>
              ...
              <div className="space-y-3">
                <div>
                  <p className="text-3xl font-semibold text-slate-50">700+</p>
                  <p className="text-xs text-slate-300">Problems solved</p>
                </div>
                <div>
            ...
            <p className="mt-5 text-[11px] text-slate-300/80">
              Focus areas: data structures, graph algorithms, dynamic
              programming, and math-heavy problems.
            </p>
          </div>
        </motion.div>
      </div>
